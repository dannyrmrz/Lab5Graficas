...
pub fn load_ship() -> Result<Vec<Vertex>, String> {
    ...
    match Obj::load("assets/models/Nave.obj") {
        ...
        Err(e) => {
            eprintln!("Warning: Could not load ship model from assets/models/Nave.obj: {:?}", e);
...
fn generate_ship_fallback() -> Vec<Vertex> {
    ...
    let make_vertex = |pos: Vec3, normal: Vec3| {
        Vertex::new(pos, normal, nalgebra_glm::Vec2::new(0.0, 0.0))
    };
